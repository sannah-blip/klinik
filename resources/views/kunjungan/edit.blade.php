...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-sm">
        <form action="{{ route('kunjunganpasien.update', $item->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nama_pasien" value="{{ old('nama_pasien', $item->nama_pasien) }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <div class="relative">
                        <select name="status"
                            class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-sm rounded-xl text-slate-700 focus:outline-none focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-50 transition-all duration-200 appearance-none cursor-pointer"
                            required>
            ...
            <div>
                ...
                <textarea name="keluhan_utama" rows="3"
                    ...
                    required>{{ old('keluhan_utama', $item->keluhan_utama) }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <textarea name="pemberian_obat" rows="3"
                        class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-sm rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-50 transition-all duration-200 resize-none"
